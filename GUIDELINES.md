...
This document represents code guide for this project.
...
* [Use UpperCamelCase for class and model names](#use-uppercamelcase-for-class-names)
...
*  ```lib``` holds the main code for the api
    * ```api``` callbacks for different routes are defined within this directory
    * ```services``` various helper methods (extra reusable modules), are termed as services.
...
### Use UpperCamelCase for class and model names
