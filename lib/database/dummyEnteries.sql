...
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Exclibur','This is an event','E101',now(),now(), 0, 3, 11,"Runnning","rules.pdf","Ther rae no rules for this",1,1);
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Exc','This is an event','E101',now(),now(), 0, 3, 11,"Runnning","rules.pdf","Ther rae no rules for this",1,1);
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Akjfk','This is an event','E101',now(),now(), 0, 3, 11,"Runnning","rules.pdf","Ther rae no rules for this",1,1);
...
Insert Into `CoordinatorEvents` values(default,2,3);
INSERT INTO `GuestLectures` (`Id`, `Start`, `End`, `Photo`, `Description`, `GuestName`, `Venue`) VALUES (NULL, '2017-01-17 05:17:19', '2016-12-22 00:00:00', 'https://apps-static.flock.co/urlunfurl/unfurl1482268038a9d6665', 'Description for this talk goes here', 'Anshul', 'Senate Hall');
INSERT INTO `WishLists` (`Id`, `LectureId`, `StudentId`) VALUES (NULL, '1', '1');
