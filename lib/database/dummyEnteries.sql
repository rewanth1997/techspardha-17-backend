...
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Exclibur','This is an event','E101',now(),now(), 0, 3, 11,"Running","rules.pdf","Ther rae no rules for this",1,1);
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Exc','This is an event','E101',now(),now(), 0, 3, 11,"Running","rules.pdf","Ther rae no rules for this",1,1);
Insert into `Events` (`Name`, `Description`, `Venue`, `Start`, `End`, `CurrentRound`, `TotalRounds`, `MaxContestants`, `Status`, `Pdf`, `Rules`, `CategoryId`, `SocietyId`) Values('Akjfk','This is an event','E101',now(),now(), 0, 3, 11,"Running","rules.pdf","Ther rae no rules for this",1,1);
